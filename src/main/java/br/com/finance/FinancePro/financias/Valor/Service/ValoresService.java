package br.com.finance.FinancePro.financias.Valor.Service;


import br.com.finance.FinancePro.financias.Valor.Model.ValoresModel;
import br.com.finance.FinancePro.financias.Valor.Repository.ValoresRepository;
...
public class ValoresService {
    ...
    public void delete(Long id) {valoresRepository.deleteById(id);}
